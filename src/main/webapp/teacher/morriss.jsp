            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="${pageContext.request.contextPath}/findByNamessr" id="form1" method="post">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="请输入姓名" name="findByNamessr">
                                <span class="input-group-addon btn" id="sub">搜索</span>
                            </div>
                        </form>
                        <button class="btn btn-default col-md-2" style="margin-top: 20px" onClick="location.href='/teacher/addCourse.jsp'">
                            添加课程信息
                ...
                <table class="table table-bordered">
                    ...
                    <c:forEach  items="${list}" var="item">
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-default btn-xs btn-info" onClick="location.href='teacher/editCourse.jsp?id=${item.courseId}'">修改</button>
                                <button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='/deleteCourser?id=${item.courseId}'">删除</button>
                                <!--弹出框-->
                            </td>
                        </tr>
                    </c:forEach>
