...
<%--                                        <input type="hidden" name="examId" value="${item.lianxiId}">--%>
                                        <input type="hidden" name="examName" value="${item.lianxiName}">
                                ...
                                <div class="test" style="margin-top:10px;">
                                    <div class="test_con">
                                        <div class="item">
                                            ...
                                            <input type="hidden" name="examId" value="${items.lianxiId}">
                                            <input type="hidden" name="examName" value="${items.lianxiName}">
...
<script type="text/javascript">
    ...
    window.onload=function(){
        $("#Question").value=$("#Question").children().children().val(value);
