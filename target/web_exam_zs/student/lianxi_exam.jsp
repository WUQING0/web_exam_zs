        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/showLianxitest" id="editfrom" method="post">
                        <div class="form-group ">
                            <label  class="col-sm-2 control-label" >选择考试科目</label>
                            <div class="col-sm-10">
                               <input type="text" name="type" placeholder="请输入练习科目" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group" style="text-align: center">
                            <button class="btn btn-default" type="submit">开始练习</button>
                        </div>
                    </form>
                </div>
